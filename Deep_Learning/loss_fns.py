...
# def multiscale_l1_laplacian_loss_sorted(p_t, p_w, t_t, t_w, inv_scale_factors):
#     t_t = torch.sort(t_t, 1)[0]
...
#     ####################
#     loss = D
#     # losses = [-torch.exp(-D/sf) for sf in inv_scale_factors] # this is likely imprecise ...
#     return sum(losses)
