...
class DeepLoco(nn.Module):
    def __init__(self, net_filters = 16, conv_block_depth = 2, initial_filter_size = 5, filter_size = 3, resnet_out_dim = 1024, resnet_depth = 2, max_points = 5, min_coords = [0,0], max_coords = [64,64] ):
